...
#data
unicef_indicator_1.clean <- read.csv("unicef_indicator_1 clean.csv", sep=";")
unicef_indicator_2.clean <- read.csv("unicef_indicator_2 clean.csv", sep=";")
unicef_metadata.life.exp <- read.csv("unicef_metadata life exp.csv", sep=";")
